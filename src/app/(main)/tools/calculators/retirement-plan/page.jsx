                  ...
                  <div className="input-fields mt-5 mb-10">
                    ...
                    <div className="items-center mt-5">
                      ...
                      <Input
                        ...
                        style={{
                          "--progress":
                            (((isNaN(lifeExpectancy) ? 0 : lifeExpectancy) -
                              35) /
                              (100 - 35)) *
                              100 +
                            "%",
                    ...
                    <div className="items-center mt-5">
                      ...
                      <Input
                        ...
                        style={{
                          "--progress":
                            (((isNaN(currentlyMonth) ? 0 : currentlyMonth) -
                              1000) /
                              (10000000 - 1000)) *
                              100 +
                            "%",
                    ...
                    <div className="items-center mt-5">
                      ...
                      <input
                        ...
                        step="1"
                        value={
                          isNaN(Number(pretrement)) ? 0 : Number(pretrement)
                        }
                        onChange={handlePreretrement}
                        className="customRange w-full"
                        style={{
                          "--progress":
                            ((isNaN(Number(pretrement))
                              ? 0
                              : Number(pretrement) - 1) /
                              (30 - 1)) *
                              100 +
                    ...
                    <div className="items-center mt-5">
                      <div className="flex justify-between">
                        ...
                        <input
                          ...
                          placeholder="0"
                          value={
                            postretrement === "" ? "" : Number(postretrement)
                          }
                      ...
                      <input
                        ...
                        step="1"
                        value={
                          isNaN(Number(postretrement))
                            ? 0
                            : Number(postretrement)
                        }
                        onChange={handlePostretrement}
                        className="customRange w-full"
                        style={{
                    ...
                    <div className="mt-5">
                      ...
                      <div className="flex justify-between px-5 mb-3">
                        ...
                        <p className="font-bold text-lg">
                          {amountToCommaSeperated(totalThroughSips)}
                        </p>
                      </div>
                      <hr className="mb-3" />
                      <div className="flex justify-between px-5 mb-3">
