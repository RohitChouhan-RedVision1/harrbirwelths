...
export const metadata = {
  ...
  description:
    "Grow your savings with fixed deposits offering guaranteed returns, flexible tenures, and capital safety for all investor types.",
};

const FixedDeposit = async () => {
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mb-4">
              ...
              Deposits (FDs) are a time-tested savings option offering capital
              protection and guaranteed interest income. At{" "}
              <strong>{sitedata.websiteName}</strong>, we provide access to
              corporate and bank FDs with competitive rates and flexible tenures
              suited to your financial objectives.
            </p>

            <p className="mb-4">
              Whether you're planning for short-term needs or seeking a safe
              haven for your long-term savings, FDs help you grow your wealth
              with peace of mind and predictable returns.
            </p>

            {/* Key Benefits */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 mb-4">
              {[
                "Assured Returns with Zero Volatility",
                "Flexible Tenure Options (from 6 months to 10 years)",
                "Higher Rates for Senior Citizens",
                "Available from Trusted Banks & Corporates",
