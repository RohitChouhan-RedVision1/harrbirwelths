                        ...
                        <div className="Scheme-calculator container mx-auto p-3 sticky top-0 z-10">
                            <div className="flex space-x-4 mb-8">
                                <Button
                                    ...
                                    className={`text-sm rounded-full hover:bg-[var(--rv-primary)] hover:text-white ${isMonthlyScheme ? "bg-[var(--rv-primary)] text-white"
                            ...
                            <Button className="bg-[var(--rv-primary)] hover:text-white text-white disabled:opacity-50 hover:bg-[var(--rv-secondary)]" onClick={() => handleSubmit()}>Show</Button>
                        </div>
                    </div>
