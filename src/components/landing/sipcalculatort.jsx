            ...
            <div className="input-fields mt-5">
              ...
              <div className="input-fields mt-5 mb-10">
                {isMonthlySip ? (
                  <div>
                    <div className="flex justify-between">
                      <h5 className="font-medium">Monthly investment (₹)</h5>
                      <div>
                        ...
                        <input
                          ...
                          className="font-bold text-lg text-[var(--rv-primary)] w-24 border p-1"
                        />
                      </div>
                    </div>
                    <input
                      ...
                      style={{
                        "--progress":
                          (((isNaN(monthlyInvestment) ? 0 : monthlyInvestment) - 500) / (50000 - 500)) * 100 +
                          "%",
                      }}
                  ...
                  <div>
                    <div className="flex justify-between">
                      <h5 className="font-medium">Total investment (₹)</h5>
                      <div>
                        <input
                    ...
                    <input
                      ...
                      style={{
                        "--progress":
                          (((isNaN(oneTimeInvestment) ? 0 : oneTimeInvestment) - 500) / (50000 - 500)) * 100 +
                          "%",
                      }}
                      className="customRange"
                    />
                ...
                <div className="items-center mt-5">
                  <div className="flex justify-between">
                    <h5 className="font-medium">Time period (Year)</h5>
                    <input
                      type="text" // Change type to number for better input handling
                      value={investmentDuration}
                      placeholder="0"
                      onChange={(e) => setDuration(e.target.value)} // Update duration
                      className="font-bold text-lg text-[var(--rv-primary)] w-16 border p-1"
                    />
                  </div>
                  <input
                    type="range"
              ...
              {result && (
                <div className="mt-4 flex flex-col justify-center items-center">
                  <div className="mb-2 text-center flex items-center justify-start gap-3">
                    <div className="w-5 h-5 bg-[var(--rv-primary)] rounded-lg flex items-center justify-center" />
                  ...
                  <div className="mb-5 text-center flex items-center justify-start gap-3">
                    <div className="w-5 h-5 bg-[var(--rv-white)] rounded-lg flex items-center justify-center" />
